...
const Orders: React.FC = () => {
  ...
  className="min-w-[140px] rounded-md text-xs border-brand-red bg-red-50 text-brand-red hover:bg-brand-red hover:text-white transition-all flex items-center justify-center gap-1.5"
>
